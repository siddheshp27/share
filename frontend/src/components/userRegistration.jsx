...
const Register = () => {
  let [userData, setUserData] = useState({ userName: '', name: '', email: '', password: '' });
  ...
  const submitHandle = async (e) => {
    e.preventDefault();
    console.log(userData, userData.password, e.target.password_confirmation.value);
    if (userData.password === e.target.password_confirmation.value) {
      await axios.post('http://localhost:3000/api/auth/registerUser', userData);
      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            ...
            <h1 className="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">Register to Secure Storage</h1>

            <p className="mt-4 leading-relaxed text-gray-500">A secure Blockchain based platform for storage, sharing and verification of Images.</p>
